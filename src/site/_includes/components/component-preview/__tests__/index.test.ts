...
const html = `
  <div class="original-class js-guidance-component-preview-iframe" data-example-name="test-component" data-iframe-id="test-component--iframe" data-iframe-title="test-component-title">
...
describe('initComponentPreviewsIframe', () => {
  ...
  it('replaces content with iframe', async () => {
    ...
    expect(iframe?.src).toBe('preview/test-component/embed.html')
  })
})
